...
#define COCOAPODS_POD_AVAILABLE_MKNetworkKit_RACExtensions
#define COCOAPODS_VERSION_MAJOR_MKNetworkKit_RACExtensions 0
#define COCOAPODS_VERSION_MINOR_MKNetworkKit_RACExtensions 2
#define COCOAPODS_VERSION_PATCH_MKNetworkKit_RACExtensions 0
